          ...
          <footer className="bg-white border-t border-gray-100 py-12 mt-20">
            <div className="max-w-7xl mx-auto px-4 text-center">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="text-lg font-bold text-gray-900">Vault<span className="text-indigo-600">4K</span></span>
              </div>
              <p className="text-gray-500 text-sm mb-8">© 2026 4K Wallpaper Vault. All rights reserved. High-quality wallpapers for your desktop and mobile.</p>
